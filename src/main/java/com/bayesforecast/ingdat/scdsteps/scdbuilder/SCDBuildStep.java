...
package com.bayesforecast.ingdat.scdsteps.scdbuilder;
...
import com.bayesforecast.ingdat.scdsteps.scdbuilder.treealgo.GeneralFillStateTreeAlgorithm;
import com.bayesforecast.ingdat.scdsteps.scdbuilder.treealgo.GeneralStateTreeAlgorithm;
import com.bayesforecast.ingdat.scdsteps.scdbuilder.treealgo.OrderedFillStateTreeAlgorithm;
import com.bayesforecast.ingdat.scdsteps.scdbuilder.treealgo.OrderedStateTreeAlgorithm;
import com.bayesforecast.ingdat.scdsteps.scdbuilder.treealgo.StateTreeAlgorithm;
...
public class SCDBuildStep extends BaseStep implements StepInterface {
 		
	
	/** The meta. */
	private SCDBuildStepMeta meta;
	
	/** The data. */
	SCDBuildStepData data;
	 ...
	 */
	public SCDBuildStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis) {
	...
	public boolean init(StepMetaInterface smi, StepDataInterface sdi) {
		...
		meta = (SCDBuildStepMeta) smi;
		data = (SCDBuildStepData) sdi;
	...
	public void dispose(StepMetaInterface smi, StepDataInterface sdi) {
		...
		((SCDBuildStepData) sdi).items.clear();
	...
	private void emitTree(){
		SCDBuildStepData data = (SCDBuildStepData) this.getStepDataInterface();
	 ...
	 */
	public void emitItem(SCDBuildStepData data, Item item, boolean emitLastState){
