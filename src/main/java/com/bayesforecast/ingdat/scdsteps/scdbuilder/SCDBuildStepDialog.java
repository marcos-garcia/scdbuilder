 ...
 * 
 */
public class SCDBuildStepDialog extends BaseStepDialog implements
		StepDialogInterface {
	 ...
	 *            the step name
	 */
	public SCDBuildStepDialog(Shell parent, Object in, TransMeta transMeta,
			String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		meta = (SCDBuildStepMeta) in;
	}
