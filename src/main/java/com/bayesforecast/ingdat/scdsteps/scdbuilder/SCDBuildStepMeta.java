...
public class SCDBuildStepMeta extends BaseStepMeta implements StepMetaInterface {
	 ...
	 */
	private static Class<?> PKG = SCDBuildStepMeta.class; // for i18n purposes
	...
	public StepDialogInterface getDialog(Shell shell, StepMetaInterface meta, TransMeta transMeta, String name) {
		return new SCDBuildStepDialog(shell, meta, transMeta, name);
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans disp) {
		return new SCDBuildStep(stepMeta, stepDataInterface, cnr, transMeta, disp);
	}
